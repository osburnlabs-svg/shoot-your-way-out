    ...
    <GestureDetector gesture={panGesture}>
      <View style={StyleSheet.absoluteFill}>
        <Canvas style={StyleSheet.absoluteFill}>
          ...
          {/* Screen-space (not in camera Group). Tuning: edge alpha 0.6,           */}
          {/* radius = 0.6 × screen diagonal. Increase alpha or decrease multiplier  */}
          {/* to darken more; decrease alpha or increase multiplier to lighten.       */}
          <Rect x={0} y={0} width={width} height={height}>
            <RadialGradient
              c={{ x: width / 2, y: height / 2 }}
              r={Math.sqrt(width * width + height * height) * 0.6}
