...
| 5 — Maps + obstacles + vehicle enemies | 🟡 In Progress | 2026-05-13 | G1: 99bf87d→3c17fac G2: Step1+2 stable, Step3 f12a73d + GC fix 5187d0d | G1 ✅ G2-Steps1+2 ✅ G2-Step3 🔴 | Blocker 1 (stutter) addressed/accepted for v1 via JS-thread GC fix; working on blockers 2 (missing categories) + 3 (sprite scale) |
