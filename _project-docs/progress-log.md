...
| 4a — Stat skills + level-up | 🟡 In Progress | 2026-05-10 | G1: c4daad8 G2: a095517 G3: f297b4b G3-polish: (pending) | G1 ✅ G2 ✅ G3 pending device test | G1: XP curve. G2: 10 skills + pierce + regen. G3: level-up modal. G3-polish: modal BG crop + icon swaps + hit flash radius |
